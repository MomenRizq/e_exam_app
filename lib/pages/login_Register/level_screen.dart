        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                if (lvl == Lvl.one) {
                  levelName = "627e897fb43d50276042d97f";
                } else if (lvl == Lvl.two) {
                  levelName = "627e8989b43d50276042d982";
                } else if (lvl == Lvl.three) {
                  levelName = "627e89a6b43d50276042d985";
                } else {
                  levelName = "627e89b0b43d50276042d989";
                }

                if (dep == Dep.general) {
                  departName = "627e89dfb43d50276042d98c";
                } else {
                  departName = "627e8a0cb43d50276042d99";
                }
